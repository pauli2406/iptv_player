...
SeriesItem _seriesItemDeserialize(
  ...
  final object = SeriesItem(
    ...
    streamUrl: reader.readStringOrNull(offsets[16]),
...
extension SeriesItemQueryFilter
  ...
  QueryBuilder<SeriesItem, SeriesItem, QAfterFilterCondition> streamUrlEqualTo(
    String? value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SeriesItem, SeriesItem, QAfterFilterCondition> streamUrlLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<SeriesItem, SeriesItem, QAfterFilterCondition> streamUrlBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<SeriesItem, SeriesItem, QAfterFilterCondition> streamUrlEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SeriesItem, SeriesItem, QAfterFilterCondition> streamUrlContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<SeriesItem, SeriesItem, QAfterFilterCondition> streamUrlMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
...
extension SeriesItemQuerySortBy
  ...
  QueryBuilder<SeriesItem, SeriesItem, QAfterSortBy> sortByStreamUrl() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'streamUrl', Sort.asc);
    });
  }

  QueryBuilder<SeriesItem, SeriesItem, QAfterSortBy> sortByStreamUrlDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension SeriesItemQuerySortThenBy
  ...
  QueryBuilder<SeriesItem, SeriesItem, QAfterSortBy> thenByStreamUrl() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'streamUrl', Sort.asc);
    });
  }

  QueryBuilder<SeriesItem, SeriesItem, QAfterSortBy> thenByStreamUrlDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'streamUrl', Sort.desc);
    });
  }
...
extension SeriesItemQueryWhereDistinct
  ...
  QueryBuilder<SeriesItem, SeriesItem, QDistinct> distinctByStreamUrl(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension SeriesItemQueryProperty
  ...
  QueryBuilder<SeriesItem, String?, QQueryOperations> streamUrlProperty() {
    return QueryBuilder.apply(this, (query) {
